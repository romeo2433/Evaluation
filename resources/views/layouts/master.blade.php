...
<!-- /#sidebar-wrapper -->
    ...
    <nav id="myNavmenu" class="navmenu navmenu-default navmenu-fixed-left offcanvas-sm" role="navigation">
        <div class="list-group panel">
            ...
            <a href="#data-management" class=" list-group-item" data-toggle="collapse" data-parent="#MainMenu"><i
                        class="fa fa-database sidebar-icon"></i><span id="menu-txt">{{ __('Data Management') }}</span>
                <i class="icon ion-md-arrow-dropup arrow-side sidebar-arrow"></i></a>
            <div class="collapse" id="data-management">
                <a href="{{ route('data.cleaning')}}" class="list-group-item childlist">
                    <i class="bullet-point"><span></span></i> {{ __('Table Cleaning') }}</a>
                <a href="{{ route('data.import')}}" class="list-group-item childlist">
                    <i class="bullet-point"><span></span></i> {{ __('Data Import') }}</a>
                <a href="{{ route('data.generation')}}" class="list-group-item childlist">
                    <i class="bullet-point"><span></span></i> {{ __('Data Generation') }}</a>
            </div>
        </div>
    </nav>
